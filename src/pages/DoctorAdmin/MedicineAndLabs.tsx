...
<div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-1">Effects/Side Effects</label>
            <textarea
      ...
      <table className="w-full border-collapse border border-gray-200">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border border-gray-200 px-4 py-2 text-left">Composition</th>
            <th className="border border-gray-200 px-4 py-2 text-left">Usage</th>
            <th className="border border-gray-200 px-4 py-2 text-left">Effects</th>
        ...
        <tbody>
          {medicines.map((medicine) => (
            <tr key={medicine.serial_number} className="hover:bg-gray-50">
              <td className="border border-gray-200 px-4 py-2">{medicine.medicine_name}</td>
              <td className="border border-gray-200 px-4 py-2">{medicine.medicine_company}</td>
              <td className="border border-gray-200 px-4 py-2">{medicine.medicine_composition}</td>
              <td className="border border-gray-200 px-4 py-2">{medicine.medicine_usage || '-'}</td>
              <td className="border border-gray-200 px-4 py-2">{medicine.medicine_effects || '-'}</td>
  ...
  {showTestModal && (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        <h3 className="text-xl font-semibold text-gray-800 mb-6">Add New Test</h3>
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
  ...
  {/* Tests List as Table */}
  <div className="bg-white p-6 rounded-lg shadow-sm mt-8">
    <h3 className="text-xl font-semibold text-gray-800 mb-6">Tests List</h3>
    {isLoading ? (
      <div className="flex justify-center py-8">
        ...
        <tbody>
          {tests.map((test) => (
            <tr key={test.id} className="hover:bg-gray-50">
              <td className="border border-gray-200 px-4 py-2">{test.test_name}</td>
